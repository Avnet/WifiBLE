...
static void ButtonTimerEventHandler(EventData *eventData)
{
    ...
    if (button2Event == ButtonEvent_Error) {
        ...
        deviceControlLedState = (deviceControlLedState == GPIO_Value_Low ? GPIO_Value_High : GPIO_Value_Low);
        //GPIO_SetValue(deviceControlLedGpioFd, deviceControlLedState);
...
static int InitPeripheralsAndHandlers(void)
{
    ...
    bleAdvertiseToBondedDevicesLedGpioFd = GPIO_OpenAsOutput(SAMPLE_RGBLED_BLUE, GPIO_OutputMode_PushPull, GPIO_Value_High);
    ...
    bleAdvertiseToAllDevicesLedGpioFd = GPIO_OpenAsOutput(SAMPLE_RGBLED_RED, GPIO_OutputMode_PushPull, GPIO_Value_High);
    ...
    bleConnectedLedGpioFd = GPIO_OpenAsOutput(SAMPLE_RGBLED_GREEN, GPIO_OutputMode_PushPull, GPIO_Value_High);
    ...
    //deviceControlLedGpioFd = GPIO_OpenAsOutput(SAMPLE_LED, GPIO_OutputMode_PushPull, deviceControlLedState);
